const Button = ({ type = "button", text, onClick, disabled }) => (
  <button
    ...
    disabled={disabled}
    className={`
      relative px-4 py-2 sm:px-6 sm:py-3 md:px-8 md:py-3   /* reduced vertical padding */
  ...
  >
    ...
    {/* Text Content */}
    <span className="relative z-10 text-pink-700 font-black text-sm sm:text-base md:text-lg">{text}</span>
